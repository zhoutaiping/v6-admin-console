  ...
  <div class="column-btn-sort">
    ...
    <div v-if="type === 'text'">
      ...
      >
        ...
        ><i class="iconfont icon-arrow-to-top" /></el-button>
      </el-tooltip>
      <el-tooltip
        content="上移"
        placement="top"
      >
        <el-button
          ...
          type="text"
          @click="handleClick('up')"
        ><i class="iconfont icon-long-arrow-up" /></el-button>
      ...
      >
        <el-button
          ...
          type="text"
          @click="handleClick('down')"
        ><i class="iconfont icon-long-arrow-down" /></el-button>
      </el-tooltip>
      <el-tooltip
        content="置底"
        placement="top"
      >
        ...
        ><i class="iconfont icon-arrow-to-bottom" /></el-button>
      </el-tooltip>
    </div>
  </div>
</template>
