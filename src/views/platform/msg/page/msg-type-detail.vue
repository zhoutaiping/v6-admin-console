...
import AddEdit from '../components/add-edit-type-detail'
export default {
  components: { AddEdit },
  mixins: [consoleData],
  ...
  data() {
    return {
      ...
      column: [
        ...
        { label: '消息模板', dataIndex: 'name', cell: 'name' },
        { label: '消息类型标识', dataIndex: 'desc' },
        { label: '告警类型', dataIndex: 'params' },
