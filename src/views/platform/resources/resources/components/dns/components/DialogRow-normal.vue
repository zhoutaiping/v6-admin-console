...
<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="节点数量" prop="node_num">
        <DmSelect
          v-model="form.node_num"
          :selects="options.node_num"
          class="input-box"
          placeholder=" "
          @change="e =>{
            selectTemplate = []
