  ...
  data() {
    return {
      ...
      column: [
        ...
        { label: '销售', prop: 'sales', width: 150 },
        { label: '支付邮箱', prop: 'email', width: 150 },
        { label: '打款人', prop: 'flow_people', width: 150 },
        { label: '收款打款路线', prop: 'flow_source', width: 150 },
        { label: '收款打款金额', prop: 'flow_money', width: 150 },
        { label: '收款打款时间', prop: 'flow_time', width: 150 },
